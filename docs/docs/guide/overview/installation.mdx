...
Materio is built using [Create Next App](https://nextjs.org/docs/app/api-reference/create-next-app). Create Next App sets up everything automatically for you.
