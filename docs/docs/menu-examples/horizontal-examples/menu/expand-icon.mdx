...
<IframeWindow url='https://demos.themeselection.com/materio-mui-nextjs-admin-template/demo-1/en/menu-examples/horizontal-menu/menu/expand-icon/with-params' />
...
<IframeWindow url='https://demos.themeselection.com/materio-mui-nextjs-admin-template/demo-1/en/menu-examples/horizontal-menu/menu/expand-icon/without-params' />
