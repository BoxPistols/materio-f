...
<IframeWindow url="https://demos.themeselection.com/materio-mui-nextjs-admin-template/demo-1/en/menu-examples/horizontal-menu/menu/menu-item-styles/with-params" />
...
<IframeWindow url="https://demos.themeselection.com/materio-mui-nextjs-admin-template/demo-1/en/menu-examples/horizontal-menu/menu/menu-item-styles/without-params" />
