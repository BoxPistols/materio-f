...
import SourceCodeWithParams from "!!raw-loader!@/app/[lang]/menu-examples/horizontal-menu/menu/menu-item-styles/with-params/page";
import SourceCodeWithoutParams from "!!raw-loader!@/app/[lang]/menu-examples/horizontal-menu/menu/menu-item-styles/without-params/page";
...
<IframeWindow url="https://demos.themeselection.com/materio-mui-react-nextjs-admin-template/demo-1/en/menu-examples/horizontal-menu/menu/menu-item-styles/with-params" />
...
<IframeWindow url="https://demos.themeselection.com/materio-mui-react-nextjs-admin-template/demo-1/en/menu-examples/horizontal-menu/menu/menu-item-styles/without-params" />
