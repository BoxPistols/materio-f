...
import SourceCode from '!!raw-loader!@/app/[lang]/menu-examples/horizontal-menu/submenu/disabled/page'
...
<IframeWindow url='https://demos.themeselection.com/materio-mui-react-nextjs-admin-template/demo-1/en/menu-examples/horizontal-menu/submenu/disabled' />
