...
import SourceCodeWithParams from '!!raw-loader!@/app/[lang]/menu-examples/vertical-menu/menu/expand-icon/with-params/page'
import SourceCodeWithoutParams from '!!raw-loader!@/app/[lang]/menu-examples/vertical-menu/menu/expand-icon/without-params/page'
...
<IframeWindow url='https://demos.themeselection.com/materio-mui-react-nextjs-admin-template/demo-1/en/menu-examples/vertical-menu/menu/expand-icon/with-params' />
...
<IframeWindow url='https://demos.themeselection.com/materio-mui-react-nextjs-admin-template/demo-1/en/menu-examples/vertical-menu/menu/expand-icon/without-params' />
