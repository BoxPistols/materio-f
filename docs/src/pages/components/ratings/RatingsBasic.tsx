...
const RatingsBasic = () => {
  ...
  return (
    <>
      <div className='mbe-3'>
        <Typography className='font-medium' color='text.primary'>Controlled</Typography>
      ...
      <div className='mbe-3'>
        <Typography className='font-medium' color='text.primary'>Disabled</Typography>
        <Rating disabled value={value} name='disabled' />
      </div>
      <div>
        <Typography className='font-medium' color='text.primary'>No rating given</Typography>
